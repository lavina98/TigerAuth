// export const words = ["the", "of", "and", "a", "to", "in", "is", "you", "that", "it", "he", "was", "for",
...
// https://172.16.40.241:4200

// ng serve --ssl true --ssl-cert "./ssl/server.crt" --ssl-key "./ssl/server.key" --host 172.16.40.241
